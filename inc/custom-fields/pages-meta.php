...
function crb_page_theme_options() {
    ...
    ->add_fields( array(
        ...
        Field::make( 'complex', 'crb_contact_kiev_contact', 'Контакты (Киев)' )->add_fields( array(
        ...
        Field::make( 'complex', 'crb_contact_kvarkov_contact', 'Контакты (Харьков)' )->add_fields( array(
